...
with open('rozklad.txt') as f:
    choices = f.read().splitlines()

with open('404.txt') as f:
    choices2 = f.read().splitlines()

with open('LegalM.txt') as f:
    choices3 = f.read().splitlines()
...
def start(x):
    ...
    keyboard.add(*[types.KeyboardButton(name) for name in ['Розклад', 'Центри', 'Організації', 'Q&A', "Мапа", 'Legal misc', 'Кафедри', 'Контакти']])
...
def start(x):
    keyboard = types.ReplyKeyboardMarkup(resize_keyboard=True)
    keyboard.add(*[types.KeyboardButton(name) for name in ['Розклад', 'Центри', 'Організації', 'Q&A', "Мапа", 'Кафедри', 'Legal misc', 'Контакти']])
...
def query_text(inline_query):
    try:
       r = types.InlineQueryResultArticle('1.', 'Мельник Роман Сергійович', types.InputTextMessageContent(
                'В. О. зав. кафедри адміністративного права <b>(324 аудиторія)</b>, Мельник Роман Сергійович', parse_mode='html'), thumb_url=char_icon,
                                               thumb_width=48, thumb_height=48)
       r2 = types.InlineQueryResultArticle('2.', 'Бевзенко Володимир Михайлович', types.InputTextMessageContent(
                'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Бевзенко Володимир Михайлович', parse_mode='html'), thumb_url=char_icon,
                                               thumb_width=48, thumb_height=48)
       r3 = types.InlineQueryResultArticle('3.', 'Гриценко Іван Сергійович', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Гриценко Іван Сергійович',
           parse_mode='html'), thumb_url=char_icon,
                                           thumb_width=48, thumb_height=48)
       r4 = types.InlineQueryResultArticle('4.', 'Берлач Анатолій Іванович', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Берлач Анатолій Іванович',
           parse_mode='html'), thumb_url=char_icon,
                                           thumb_width=48, thumb_height=48)
       r5 = types.InlineQueryResultArticle('5.', 'Діхтієвський Петро Васильович', types.InputTextMessageContent(
       ...
       r20 = types.InlineQueryResultArticle('20.', 'Барікова Анна Анатоліївна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Барікова Анна Анатоліївна',
           parse_mode='html'), thumb_url=char_icon,
                                           thumb_width=48, thumb_height=48)
       r21 = types.InlineQueryResultArticle('21.', 'Белей Єлизавета Несторівна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Белей Єлизавета Несторівна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r22 = types.InlineQueryResultArticle('22.', 'Бєлінгіо Валерія Олександрівна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Бєлінгіо Валерія Олександрівна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r23 = types.InlineQueryResultArticle('23.', 'Клинчук Вікторія Іванівна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Клинчук Вікторія Іванівна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r24 = types.InlineQueryResultArticle('24.', 'Костенко Андрій Олександрович', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Костенко Андрій Олександрович',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r25 = types.InlineQueryResultArticle('25.', 'Левчишина Олена Леонідівна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Левчишина Олена Леонідівна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r26 = types.InlineQueryResultArticle('26.', 'Медвідчук Ганна Василівна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Медвідчук Ганна Василівна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r27 = types.InlineQueryResultArticle('27.', 'Проскурін Олексій Валентинович', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Проскурін Олексій Валентинович',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r28 = types.InlineQueryResultArticle('28.', 'Семеній Олена Миколаївна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Семеній Олена Миколаївна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r29 = types.InlineQueryResultArticle('29.', 'Солодва Катерина Юріївна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Солодва Катерина Юріївна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)
       r30 = types.InlineQueryResultArticle('30.', 'Чернявська Богдана Вадимівна', types.InputTextMessageContent(
           'Викладач кафедри адміністративного права <b>(324 аудиторія)</b>, Чернявська Богдана Вадимівна',
           parse_mode='html'), thumb_url=char_icon,
                                            thumb_width=48, thumb_height=48)


       r31 = types.InlineQueryResultArticle('31.', 'Про кафедру', types.InputTextMessageContent(
       ...
       bot.answer_inline_query(inline_query.id, [r,	r2,	r3,	r4,	r5,	r6,	r7,	r8,	r9,	r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31])
    except Exception as e:
       print(e)
#-----------------------------------------Inline
...
def potik(message):
    ...
    #Q&A
    elif message.text == 'Верхній\нижній тижні':
       bot.send_message(message.chat.id, random.choice(choices))
    elif message.text == 'Інше питання':
       bot.send_message(message.chat.id,'На жаль, зараз база Q&A є трішки пустенькою, тому, скоріш за все, зараз вам необхідно буде відправитися за інформацією до методиста, прошу пробачення за такі незручності. Якщо у вас є питання, яке непогано було б розмістити тут - сміливо звертайтесь @Octeract. Фідбек - завжди добре!')


    #Legal Misc
    elif message.text == 'LegalWizardBot':
       bot.send_message(message.chat.id, 'Legaltech - трендова, але все ще неприборкана річ, хоча б базове знання якої є суттєвим плюсом в очах роботодавця. Саме тому, було б непогано звернути увагу на проект, провідну роль у створенні якого відіграв аспірант юридичного факультету КНУ, Андрій Костенко, спеціаліст з юридичної інженерії у Axon Partners. Legalwizardbot – це онлайн платформа для конструювання юридичних ботів та спілкування з ними. Інтригуюче? У ще більш красномовній формі про проект можна дізнатися тут https://www.facebook.com/andrkostenko/posts/908527965962537?pnref=story')
    elif message.text == 'Legal.random':
        bot.send_message(message.chat.id, random.choice(choices3))
...
#-------------------------------------------------------------------------
       ...
       bot.send_message(message.chat.id,
        ...
        bot.send_message(message.chat.id,
                         '<b>Виявлено помилку? Є пропозиції стосовно контенту бота?</b> Звертайтесь сюди – @Octeract \n\n<b>Більше про інші проекти Асоціації, співпрацю</b> можна дізнатися на <a href="https://alumni.law.knu.ua/">Сайті Асоціації</a> \n\n<b>Електронна скринька Асоціації</b> – alumnilawknu@gmail.com \n\n<b>Чекаємо на Ваші відгуки та цікаві пропозиції!</b>',
                         parse_mode="HTML")
    else:
       bot.send_message(message.chat.id, random.choice(choices2))
